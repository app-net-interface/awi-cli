...
In this demo we will show how to setup connections between VPCs using MyCelium: Application WAN Interface.
We will show how to:
...
read -p ""
read -p "For now we don't have any connections between networking domains created"
pe "./myCelium list connection"
read -p ""
clear
read -p "In our demo we will try to connect staging VPC to development VPC"
...
pe "cat examples/vpc-vpc-demo-allow.yaml"
read -p ""
read -p "Now let's run myCelium CLI to create connection..."
pe "./myCelium create connection --connection-config examples/vpc-vpc-demo-allow.yaml"
read -p ""
...
pe "./myCelium delete connection vpc-08532095b01548260:vpc-043444b8201ca823d"
read -p ""
pe "./myCelium list connection"
read -p ""
...
pe "./myCelium create connection --connection-config examples/vpc-vpc-demo-deny.yaml"
read -p ""
...
clear
read -p "In this demo we showed how to create connection with default access rules between network domains using AWI CLI"
